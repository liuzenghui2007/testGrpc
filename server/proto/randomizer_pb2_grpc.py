...
class RandomizerService(object):
    ...
    def Get2DArray(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/randomizer.RandomizerService/Get2DArray',
            proto_dot_randomizer__pb2.Empty.SerializeToString,
    ...
    def Get2DArrayStream(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/randomizer.RandomizerService/Get2DArrayStream',
            proto_dot_randomizer__pb2.Empty.SerializeToString,
            proto_dot_randomizer__pb2.NumberArray2D.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
